 ...
 */
  ...
  #define PROBING_MARGIN_LEFT (X_MIN_POS + PROBING_MARGIN)
  #define PROBING_MARGIN_RIGHT (X_BED_SIZE + (-39.55) - PROBING_MARGIN)
  #define PROBING_MARGIN_FRONT (Y_MIN_POS + PROBING_MARGIN)
  #define PROBING_MARGIN_BACK (Y_BED_SIZE + (-1.35) - PROBING_MARGIN)
#endif
