 ...
 */
  ...
  // Custom definition for nozzle to probe offset
  constexpr double NOZZLE_TO_PROBE_OFFSET_ARRAY[] = NOZZLE_TO_PROBE_OFFSET;

  #define PROBE_X_OFFSET_FROM_EXTRUDER NOZZLE_TO_PROBE_OFFSET_ARRAY[0]
  #define PROBE_Y_OFFSET_FROM_EXTRUDER NOZZLE_TO_PROBE_OFFSET_ARRAY[1]
